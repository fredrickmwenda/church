...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                .append("<div class='col-md-12'><div class='input-block mb-3'><label class='control-label'>Event Name</label><input class='form-control' type='text' name='title'/></div></div>")
                .append("<div class='col-md-12'><div class='input-block mb-3'><label class='control-label'>Category</label><select class='select form-control' name='category'></select></div></div>")
