...
@section('title')
    {{trans_choice('general.add',1)}} {{trans_choice('general.batch',1)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.add',1)}} {{trans_choice('general.batch',1)}}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('contribution/batch/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
