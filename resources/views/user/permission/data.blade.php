        ...
        <table class="table responsive table-bordered table-hover table-stripped" id="">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <button class="btn bg-blue btn-xs dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Choose...<i class="fa fa-angle-down"></i></button>
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="{{ url('user/permission/'.$key->id.'/edit') }}"><i class="fa fa-edit"></i>
                                ...
                                <li>
                                    <a href="#" class="btn-delete" data-bs-toggle="confirmation" data-id="{{ $key->id }}" data-url="{{ url('user/permission/'.$key->id.'/delete') }}">
