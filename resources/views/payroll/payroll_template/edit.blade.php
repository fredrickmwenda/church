            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-info margin" data-bs-toggle="modal" data-bs-target="#addRow"
                ...
                <div class="col-md-6">
                    <div class="box box-solid box-primary">
                        ...
                        <div class="box-body">
                            ...
                            @endforeach
                            <div class="form-group">
                                <button type="button" class="btn btn-info margin" data-bs-toggle="modal"
                                        data-bs-target="#addRow"
