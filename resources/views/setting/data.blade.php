            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom" role="tablist">
                        ...
                        <li class="nav-item" role="presentation"><a href="#payments" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{ trans_choice('general.payment',2) }}</a></li>
                        <li class="nav-item" role="presentation"><a href="#update" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{ trans_choice('general.update',2) }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
