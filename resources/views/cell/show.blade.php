        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="user-block">
                    ...
                    <a href="{{asset('uploads/'.$member->photo)}}" class="fancybox"> <img class="img-circle" src="{{asset('uploads/'.$member->photo)}}" alt="user image" /></a>
                    @else
                    <img class="img-circle" src="{{asset('assets/dist/img/user.png')}}" alt="user image" />
                    @endif
            ...
            <div class="col-sm-3">
                <ul class="list-unstyled">
                    ...
                    <a data-bs-toggle="collapse" data-parent="#accordion" href="#viewFiles">
            ...
            <div class="col-sm-3">
                <ul class="list-unstyled">
                    <li><b>{{trans_choice('general.email',1)}}:</b> <a onclick="javascript:window.open('mailto:{{$member->email}}', 'mail');event.preventDefault()" href="mailto:{{$member->email}}">{{$member->email}}</a>

                        <div class="btn-group-horizontal"><a type="button" class="btn-xs bg-red" href="{{url('communication/email/create?member_id='.$member->id)}}">{{trans_choice('general.send',1)}}
                                {{trans_choice('general.email',1)}}</a></div>
                    </li>
                    <li><b>{{trans_choice('general.mobile_phone',1)}}:</b> {{$member->mobile_phone}}
                        <div class="btn-group-horizontal"><a type="button" class="btn-xs bg-red" href="{{url('communication/sms/create?member_id='.$member->id)}}">{{trans_choice('general.send',1)}}
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="input-group-btn">
                    <button type="button" class="btn btn-info dropdown-toggle margin" data-bs-toggle="dropdown">
                        {{trans_choice('general.member',1)}} {{trans_choice('general.statement',1)}}
                        <span class="fa fa-caret-down"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="{{url('member/'.$member->id.'/statement/print')}}" target="_blank">{{trans_choice('general.print',1)}} {{trans_choice('general.statement',1)}}</a>
                        </li>
                        <li>
                            <a href="{{url('member/'.$member->id.'/statement/pdf')}}" target="_blank">{{trans_choice('general.download',1)}} {{trans_choice('general.in',1)}} {{trans_choice('general.pdf',1)}}</a>
                        </li>
                        <li>
                            <a href="{{url('member/'.$member->id.'/statement/email')}}">{{trans_choice('general.email',1)}}
                                {{trans_choice('general.statement',1)}}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="row user-tabs">
        <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
            <ul class="nav nav-tabs nav-tabs-bottom" role="tablist">
                <li class="nav-item active" role="presentation"><a href="#tags" data-bs-toggle="tab" class="nav-link" aria-selected="false" role="tab" tabindex="-1">{{trans_choice('general.tag',2)}}</a></li>
                <li class="nav-item" role="presentation"><a href="#attendance" data-bs-toggle="tab" class="nav-link active" aria-selected="true" role="tab">{{trans_choice('general.attendance',1)}}</a></li>
                <li class="nav-item" role="presentation"><a href="#contributions" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{trans_choice('general.contribution',2)}}</a></li>
                <li class="nav-item" role="presentation"><a href="#pledges" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{trans_choice('general.pledge',2)}}</a></li>
                <li class="nav-item" role="presentation"><a href="#pledges" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{trans_choice('general.pledge',2)}}</a></li>
                <li class="nav-item" role="presentation"><a href="#family" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{trans_choice('general.family',1)}}</a></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <!-- <ul class="nav nav-tabs">
                <li class="nav-item active"><a href="#tags" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-tags"></i> </a>
                </li>
                <li class="nav-item"><a href="#attendance" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-calendar"></i> </a>
                </li>
                <li class="nav-item"><a href="#contributions" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-money"></i> </a>
                </li>
                <li class="nav-item"><a href="#pledges" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-hand-lizard-o"></i> </a>
                </li>
                <li class="nav-item"><a href="#family" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-group"></i> {{trans_choice('general.family',1)}}</a>
                </li>
            </ul> -->
            <div class="tab-content">

                <div class="tab-pane fade active show" id="tags">
                ...
                <div class="tab-pane fade" id="contributions">
                    <div class="table-responsive">
                        <table id="contributions-data-table" class="table table-bordered table-condensed table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-info btn-flat dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                {{ trans('general.choose') }} <span class="caret"></span>
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                @if(Sentinel::hasAccess('contributions.update'))
                                                <li><a href="{{ url('contribution/'.$key->id.'/edit') }}"><i class="fa fa-edit"></i> {{ trans('general.edit') }}
                                                    </a>
                                                </li>
                                                @endif
                                                @if(Sentinel::hasAccess('contributions.delete'))
                                                <li><a href="{{ url('contribution/'.$key->id.'/delete') }}" class="delete"><i class="fa fa-trash"></i> {{ trans('general.delete') }}
                                                    </a>
                                                </li>
                                                @endif
                                            </ul>
                    ...
                    <div class="table-responsive">
                        <table id="pledges-data-table" class="table table-bordered table-condensed table-hover">
                            ...
                            <tbody>
                                ...
                                $paid = $paid + \App\Models\PledgePayment::where(
                                    'pledge_id',
                                    $key->id
                                )->sum('amount');
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if($key->recurring==1)
                                        <span class="label label-success" data-bs-toggle="tooltip" title="{{trans_choice('general.recurring',1)}}"> <i class="fa fa-refresh"></i> </span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{ url('pledge/'.$key->id.'/payment/create') }}"><i class="fa fa-plus"></i>
                                                ...
                                                <li><a href="{{ url('pledge/'.$key->id.'/payment/data') }}"><i class="fa fa-money"></i> {{ trans('general.view') }} {{ trans_choice('general.payment',2) }}
                                                    </a>
                                                </li>
                                                @endif
                                                @if(Sentinel::hasAccess('pledges.update'))
                                                <li><a href="{{ url('pledge/'.$key->id.'/edit') }}"><i class="fa fa-edit"></i> {{ trans('general.edit') }}
                                                    </a>
                                                </li>
                                                @endif
                                                @if(Sentinel::hasAccess('pledges.delete'))
                                                <li><a href="{{ url('pledge/'.$key->id.'/delete') }}" class="delete"><i class="fa fa-trash"></i> {{ trans('general.delete') }}
                                                    </a>
                                                </li>
                                                @endif
                                            </ul>
                ...
                <div class="tab-pane fade" id="family">
                    <div class="btn-group-horizontal">
                        ...
                        <a type="button" class="btn btn-success margin delete" href="{{url('member/'.$member->id.'/family/create')}}">{{trans_choice('general.create',1)}}
                            {{trans_choice('general.family',1)}}</a>
                        @else
                        <a type="button" class="btn btn-info margin" href="#" data-bs-toggle="modal" data-bs-target="#addFamilyMember">{{trans_choice('general.add',1)}}
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn default" data-bs-dismiss="modal">{{trans_choice('general.close',1)}}</button>
                                    </div>
                                    {!! Form::close() !!}
                                </div>
                                <!-- /.modal-content -->
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li>
                                                <a href="#" data-href="{{ url('member/'.$key->id.'/family/edit_family_member') }}" data-bs-toggle="modal" data-bs-target="#editFamilyMember"><i class="fa fa-edit"></i> {{ trans('general.edit') }}
                                                </a>
                                            </li>
                                            @endif
                                            ...
                                            <li>
                                                <a href="{{ url('member/'.$key->id.'/family/delete_family_member') }}" class="delete"><i class="fa fa-trash"></i> {{ trans('general.remove') }}
                                                </a>
                                            </li>
                                            @endif
                                            @endif
