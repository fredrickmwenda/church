        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right mb-2">
                @if(Sentinel::hasAccess('members.create'))
                    <a href="#"
                       class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addMember"><i
                                class="fa fa-plus"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.member',1)}}
                    </a>
                @endif
                <a href="#"
                   class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#smsMember"><i
                            class="fa fa-mobile"></i> {{trans_choice('general.sms',1)}} {{trans_choice('general.member',2)}}
                </a>
                <a href="#"
                   class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#emailMember"><i
