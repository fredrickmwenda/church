    ...
    <div class="box-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('category',array('members'=>trans_choice('general.add',1).' '.trans_choice('general.member',1),'events'=>trans_choice('general.add',1).' '.trans_choice('general.event',1)),'members', array('class' => 'form-control', 'placeholder'=>trans_choice('general.select',1),'required'=>'required')) !!}
            </div>
            <div class="form-group">
