            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #132437;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-repeat: no-repeat; background-position: center top; color: #000000; background-image: url('notifications_email_template_images/blue-glow_3.jpg'); width: 600px;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        src="{{ asset('notifications_email_template_images/books-plus.png') }}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="{{ asset('notifications_email_template_images/top-rounded.png') }}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img class="big"
                                                                        src="{{ asset('notifications_email_template_images/' . $mail_type . '.jpg') }}"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff7d14; background-image: url('{{ asset('notifications_email_template_images/orange-gradient-wide.png') }}'); background-repeat: no-repeat;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    {{-- <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:52px;width:220px;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#ff7d14"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
                                                                    <div
                                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff7d14;border-radius:4px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:10px;padding-bottom:10px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                                        <span
                                                                            style="padding-left:60px;padding-right:60px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                dir="ltr"
                                                                                style="word-break: break-word; line-height: 32px;">Confirm
                                                                                Email</span></span>
                                                                    </div>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff7d14;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        class="fullMobileWidth"
                                                                        src="{{ asset('notifications_email_template_images/bottom-rounded.png') }}"
                                                                        style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;"
                                                                        width="600" /></div>
                                                            </td>
                                                        </tr>
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://www.designedwithbee.com/"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                ...
                                                                                                class="icon"
                                                                                                height="32"
                                                                                                src="{{asset('notifications_email_template_images/bee.png')}}"
