            ...
            <div class="col-sm-3">
                <div class="user-block">
                    ...
                    <a href="{{ asset('uploads/' . $member->photo) }}" class="fancybox"> <img class="img-circle"
                            src="{{ asset('uploads/' . $member->photo) }}" alt="user image" /></a>
                    @else
                    <img class="img-circle" src="{{ asset('assets/dist/img/user.png') }}" alt="user image" />
                    @endif
                    <span class="username">{{ $member->first_name }} {{ $member->middle_name }}
                        {{ $member->last_name }}</span>
                    <span class="description" style="font-size:13px; color:#000000">
                        <br>
                        <a
                            href="{{ url('member/' . $member->id . '/edit') }}">{{ trans_choice('general.edit', 1) }}</a><br>

                        {{ \Illuminate\Support\Carbon::now()->diffInYears(\Illuminate\Support\Carbon::parse($member->dob)) }}
            ...
            <div class="col-sm-3">
                <ul class="list-unstyled">
                    ...
                    <a data-bs-toggle="collapse" data-parent="#accordion" href="#viewFiles">
                        {{ trans_choice('general.view', 1) }} {{ trans_choice('general.member', 1) }}
                    ...
                    <div id="viewFiles" class="panel-collapse collapse">
                        <div class="box-body">
                            ...
                            @if($member->files)
                                ...
                                @else
                                    <p>No files available for this member.</p>
                                @endif
                            @else
                                <li>No files available for this member.</li>
                            @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="{{ url('member/' . $member->id . '/statement/print') }}"
                                target="_blank">{{ trans_choice('general.print', 1) }}
                                {{ trans_choice('general.statement', 1) }}</a>
                        </li>
                        <li>
                            <a href="{{ url('member/' . $member->id . '/statement/pdf') }}"
                                target="_blank">{{ trans_choice('general.download', 1) }}
                                {{ trans_choice('general.in', 1) }} {{ trans_choice('general.pdf', 1) }}</a>
                        </li>
                        <li>
    ...
    <div class="row user-tabs">
        <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
            <ul class="nav nav-tabs nav-tabs-bottom" role="tablist">
                <li class="nav-item active" role="presentation"><a href="#tags" data-bs-toggle="tab" class="nav-link" aria-selected="false" role="tab" tabindex="-1">organizations</a></li>
        ...
        <div class="nav-tabs-custom">
            <!-- <ul class="nav nav-tabs">
                    <li class="nav-item active">
                        <a href="#tags" data-bs-toggle="tab" aria-expanded="false">
                            <i class="fa fa-tags"></i>
                            {{-- {{ trans_choice('general.tag', 2) }} --}}
                            organizations
                        </a>
                    </li>
                    <li class="nav-item"><a href="#attendance" data-bs-toggle="tab" aria-expanded="false"><i
                                class="fa fa-calendar"></i> {{ trans_choice('general.attendance', 1) }}</a>
                    </li>
                    <li class="nav-item"><a href="#contributions" data-bs-toggle="tab" aria-expanded="false"><i
                                class="fa fa-money"></i> {{ trans_choice('general.contribution', 2) }}</a>
                    </li>
                    <li class="nav-item"><a href="#pledges" data-bs-toggle="tab" aria-expanded="false"><i
                                class="fa fa-hand-lizard-o"></i> {{ trans_choice('general.pledge', 2) }}</a>
                    </li>
                    <li class="nav-item"><a href="#family" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-group"></i>
                ...
                <div class="tab-pane active" id="tags">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td><a
                                        href="{{ url('organization/' . $key->tag->id . '/show') }}">{{ $key->tag->name }}</a>
                                </td>
                                <td>{!! $key->tag->notes !!}</td>
                            </tr>
                            @endif
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped data-table">
                            ...
                            <tr>
                                <td>
                                    <a
                                        href="{{ url('event/' . $key->event->id . '/show') }}">{{ $key->event->name }}</a>
                                </td>
                                <td>{!! $key->date !!}</td>
                            </tr>
                            @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if (!empty($key->batch))
                                        <a
                                            href="{{ url('contribution/batch/' . $key->batch->id . '/show') }}">
                                            {{ $key->batch->id }}
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                ...
                                                <li><a href="{{ url('contribution/' . $key->id . '/delete') }}"
                                                        class="delete"><i class="fa fa-trash"></i>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="6">
                                        ...
                                        @else
                                        <b>{{ number_format($contributions, 2) }}
                                            {{ \App\Models\Setting::where('setting_key', 'currency_symbol')->first()->setting_value }}</b>
                                        @endif
                                    </td>
                                </tr>
                            </tfoot>
                    ...
                    <div class="table-responsive">
                        <table id="pledges-data-table" class="table table-bordered table-condensed table-hover">
                            ...
                            <tbody>
                                ...
                                $paid = $paid + \App\Models\PledgePayment::where('pledge_id', $key->id)->sum('amount');
                                ?>
                                <tr>
                                    <td>
                                        @if (!empty($key->campaign))
                                        <a
                                            href="{{ url('pledge/campaign/' . $key->campaign->id . '/show') }}">
                                            {{ $key->campaign->id }}
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if ($key->recurring == 1)
                                        <span class="label label-success" data-bs-toggle="tooltip"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                ...
                                                <li>
                                                    <a
                                                        href="{{ url('pledge/' . $key->id . '/payment/create') }}"><i
                                                            class="fa fa-plus"></i>
                                                        {{ trans('general.add') }}
                                                ...
                                                <li><a
                                                        href="{{ url('pledge/' . $key->id . '/payment/data') }}"><i
                                                            class="fa fa-money"></i>
                                                        {{ trans('general.view') }}
                ...
                <div class="tab-pane " id="family">
                    <div class="btn-group-horizontal">
                        ...
                        <a type="button" class="btn btn-success margin delete"
                            ...
                            {{ trans_choice('general.family', 1) }}</a>
                        @else
                        <a type="button" class="btn btn-info margin" href="#" data-bs-toggle="modal"
                            data-bs-target="#addFamilyMember">{{ trans_choice('general.add', 1) }}
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">{{ trans_choice('general.add', 1) }}
                                            {{ trans_choice('general.member', 1) }}
                                        </h4>
                                    </div>
                                    {!! Form::open([
                                    'url' => url('member/' . $member->family->id . '/family/store_family_member'),
                                    'method' => 'post',
                                    ]) !!}
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                {!! Form::label('family_role', trans_choice('general.role', 1), ['class' => ' control-label']) !!}
                                                {!! Form::select(
                                                'family_role',
                                                [
                                                'adult' => trans_choice('general.adult', 1),
                                                'spouse' => trans_choice('general.spouse', 1),
                                                'head' => trans_choice('general.head', 1),
                                                'child' => trans_choice('general.child', 1),
                                                'unassigned' => trans_choice('general.unassigned', 1),
                                                ],
                                                null,
                    ...
                    @if (!empty($member->family))
                    <h3>{{ trans_choice('general.the', 1) }} {{ $member->family->name }}
                        {{ trans_choice('general.family', 1) }}
                    </h3>
                    <div class="table-responsive">
                        <table class="table table-striped data-table">
                            <thead>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ url('member/' . $key->member->id . '/show') }}">{{ $key->member->first_name }}
                                        {{ $key->member->middle_name }}
                                        {{ $key->member->last_name }}</a>
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li>
                                                <a href="#"
                                                    ...
                                                    data-bs-target="#editFamilyMember"><i
                                                        class="fa fa-edit"></i>
                                                    {{ trans('general.edit') }}
                                                </a>
                                            </li>
                    ...
                    <h3>{{ trans_choice('general.the', 1) }} {{ $family->family->name }}
                        {{ trans_choice('general.family', 1) }}
                    </h3>
                    <div class="table-responsive">
                        <table class="table table-striped data-table">
...
<script>
    ...
    $('#contributions-data-table').DataTable({
        ...
        buttons: [{
                extend: 'copy',
                'text': '{{ trans('general.copy') }}'
            },
            {
                extend: 'excel',
                'text': '{{ trans('general.excel') }}'
            },
            {
                extend: 'pdf',
                'text': '{{ trans('general.pdf') }}'
            },
            {
                extend: 'print',
            ...
            {
                extend: 'csv',
                'text': '{{ trans('general.csv ') }}'
            },
            {
                extend: 'colvis',
                'text': '{{ trans('general.colvis ') }}'
            }
        ],
        "paging": true,
        "lengthChange": true,
