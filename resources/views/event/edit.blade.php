    ...
    <div class="box-body">
        ...
        <div class="form-group" id="endDiv">
            ...
            <div class="col-sm-4" id="endDateDiv">
                {!! Form::text('end_date',$event->end_date, array('class' => 'form-control date-pickerr', 'id'=>"end_date",'required'=>'required')) !!}
            </div>
            <div class="col-sm-4" id="startTimeDiv">
                {!! Form::text('end_time',$event->end_time, array('class' => 'form-control time-pickerr','id'=>'end_time')) !!}
            </div>
        </div>
        <div class="form-group">
