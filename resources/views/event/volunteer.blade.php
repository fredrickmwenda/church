        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right mb-2">
                    <a href="#"
                        class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addVolunteer"><i
                            class="fa fa-plus"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.volunteer',1)}}
                    </a>
                    <a href="#"
                        class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#smsVolunteer"><i
                            class="fa fa-mobile"></i> {{trans_choice('general.sms',1)}} {{trans_choice('general.volunteer',2)}}
                    </a>
                    <a href="#"
                        class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#emailVolunteer"><i
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#showVolunteer"
                                                    data-id="{{$key->id}}"><i
                                            ...
                                            @endif
                                            @if(Sentinel::hasAccess('events.update'))
                                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#editVolunteer"
                                                    data-id="{{$key->id}}"><i
