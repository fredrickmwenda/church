...
@section('title')
    {{ trans_choice('general.add',1) }} {{ trans_choice('general.follow_up',1) }} {{ trans_choice('general.category',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.add',1) }} {{ trans_choice('general.follow_up',1) }} {{ trans_choice('general.category',1) }}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('follow_up/category/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::number('days',1, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
