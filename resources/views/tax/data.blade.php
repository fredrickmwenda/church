...
<div class="box box-default">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right mb-2">
            <a data-bs-toggle="modal" data-bs-target="#addTax" class="btn btn-info btn-sm">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a data-id="{{$key->id}}" data-bs-toggle="modal" data-bs-target="#editTax"><i class="fa fa-edit"></i>
                                ...
                                <li>
                                    <a href="#" class="btn-delete" data-bs-toggle="confirmation" data-id="{{ $key->id }}" data-url="{{ url('tax/'.$key->id.'/delete') }}">
                                        <i class="fa fa-trash"></i> {{ trans_choice('general.delete', 1) }}
                                    </a>
                                </li>
                            </ul>
                        </div>
