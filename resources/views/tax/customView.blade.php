    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <button class="btn btn-info btn-block margin-top-20" type="submit">SEARCH <i class="m-icon-swapright m-icon-white"></i></button>
                <p></p>
            </div>
            {!! Form::close() !!}
        </div>
        <div class="row">
            ...
            <table id="data-table" class="table table-bordered table-stripped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $key->id }}</td>
                        <td><a href="{{ url('client/'.$key->user_id.'/show') }}" title="{{ trans('general.click_to_view') }}"> {{ Sentinel::findUserById($key->user_id)->first_name }} {{ Sentinel::findUserById($key->user_id)->last_name }}</a>
                        </td>
                        <td>
                            <a href="{{ url('repair/'.$key->repair_id.'/show') }}" title="{{ trans('general.click_to_view') }}"> {{ \App\Models\Repair::where('id',$key->repair_id)->first()->name }} </a>
                        </td>
                        <td>{{ $key->title}}</td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>
                                        <a href="{{ url('invoice/'.$key->id.'/payment/create') }}"><i class="fa fa-plus"></i>
                                            {{ trans('invoice.add_payment') }}t</a>
                                    </li>
                                    @endif
                                    <li>
                                        <a href="{{ url('invoice/'.$key->id.'/payment/data') }}"><i class="fa fa-money"></i>
                                    ...
                                    <li>
                                        <a href="#" class="btn-delete" data-bs-toggle="confirmation" data-id="{{ $key->id }}" data-url="{{ url('invoice/'.$key->id.'/delete') }}">
