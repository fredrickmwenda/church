...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        /** PAYSTACK */
        Setting::where('setting_key', 'paystack_public_key')->update(['setting_value' => $request->paystack_public_key]);
        Setting::where('setting_key', 'paystack_secret_key')->update(['setting_value' => $request->paystack_secret_key]);
        Setting::where('setting_key', 'paystack_payment_url')->update(['setting_value' => $request->paystack_payment_url]);
        Setting::where('setting_key', 'paystack_merchant_url')->update(['setting_value' => $request->paystack_merchant_url]);
