...
class PayrollController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('payroll.create',
            compact('user', 'custom_fields', 'bottom_right', 'bottom_left', 'top_right', 'top_left', 'template','branches'));
    }
    ...
    public function pdfPayslip($payroll)
    {
        ...
        return $pdf->download( Str::slug($payroll->employee_name, "-") . "---Payslip.pdf",
            'D');
