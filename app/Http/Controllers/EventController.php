...
class EventController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('event.create', compact('branches', 'custom_fields'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('featured_image')) {
            $file = array('featured_image' => $request->file('featured_image'));
    ...
    public function show($event)
    {
        ...
        //get custom fields
        $custom_fields = CustomField::where('category', 'events')->get();
        return view('event.show', compact('event', 'custom_fields'));
    }
    ...
    public function edit($event)
    {
        ...
        //get custom fields
        $custom_fields = CustomField::where('category', 'events')->get();
        return view('event.edit', compact('event', 'locations', 'custom_fields', 'calendars', 'branches'));
    }
